...
Note_Names=["40-C.mp3","42-D.mp3","44-E.mp3","45-F.mp3","47-G.mp3","49-A.mp3","51-B.mp3","52-C.mp3","40-C.mp3","42-D.mp3","44-E.mp3","45-F.mp3","47-G.mp3","49-A.mp3","51-B.mp3","52-C.mp3","40-C.mp3","42-D.mp3","44-E.mp3","45-F.mp3","47-G.mp3","49-A.mp3","51-B.mp3","52-C.mp3"]
		...
		for Note_To_Play in range(24):
			if Notes[Note_To_Play] == True:
				if AlreadyPlaying[Note_To_Play] == False:
					...
					pygame.mixer.music.load(Note_Names[Note_To_Play])
...
#pygame.mixer.music.load('45-F.mp3')
#pygame.mixer.music.play()
